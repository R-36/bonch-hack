...
@app.route('/menu')
def menu():
    menu_elements = {'pizza1': ['pizza1.png', 'Пицца Хэппи Хат', '529', 'Куриные фрикадельки в сочетании с брусничным соусом, сочный сладкий перец, томаты и нежный сыр Моцарелла'],
                     'pizza2': ['pizza2.jpg', 'Чизбургер', '729', 'Томатный соус, сыр Моцарелла, говядина, маринованые огурцы, красный лук, кетчуп, горчица Европейская'],
                     'pizza3': ['pizza3.png', 'Европейская', '629', 'Томатный соус, сыр Моцарелла, ветчина, грибы, помидоры'],
                     'pizza4': ['pizza4.png', 'Супер Суприм', '789', 'Соус Болоньезе, сыр Моцарелла, пепперони, курица, свинина, говядина, ветчина, зеленый перец, грибы, красный лук'],
                     ...
                     'pizza7': ['pizza7.png', 'Любители Овощей', '629', 'Томатный соус, сыр Моцарелла, грибы, сладкий перец, красный лук, томаты, маслины'],
                     'pizza8': ['pizza8.png', 'Пицца Чиззи Пури', '629', 'Пицца с сырами Сулугуни и Моцарелла на нежном сливочном соусе. Ближайший родственник знаменитой Хачапури!'],
                     'pizza9': ['pizza9.jpg', 'Супер Мясная Барбекю', '789', 'Соус Барбекю, сыр Моцарелла, сыр Чеддер, ветчина, бекон, пепперони, свинина, говядина, жареный лук'],
                     'pizza10': ['pizza10.jpg', 'Четыре Сыра', '729', 'Томатный соус, сыры: Моцарелла, чеддер, сыр с голубой плесенью, Пармезан'],
                     'pizza11': ['pizza11.jpg', 'Любители Мяса', '729', 'Томатный соус, сыр Моцарелла, пепперони, свинина, говядина, ветчина, бекон'],
                     'pizza12': ['pizza12.png', 'Итальянская', '629', 'Томатный соус, сыр Моцарелла, ветчина, пепперони'],
